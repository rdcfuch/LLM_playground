...
def load_dotenv():
    ...
    os.environ['OPENAI_API_KEY'] = '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'
    os.environ['FIRECRAWL_API_KEY'] = 'fc-34f9366437b74425b1a719b762b41c18'
...
def format_data(data, fields=None):
    if fields is None:
        # fields = ["Address", "Real Estate Agency", "Price", "Beds", "Baths", "Sqft", "Home Type", "Listing Age",
        #           "Picture of home URL", "Listing URL"]
        fields = ["article-item-title","url"]
