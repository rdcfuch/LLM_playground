...
def video_qa(video_path, frames_numbers_needed=5):
    base64Frames = process_video(video_path, frames_numbers_needed=5)

    response = client.chat.completions.create(
        model=MODEL,
        messages=[
        {"role": "system", "content": "You are a professional cinematoghrapher. Please provide a summary of the video. you need to capture some key information from it, including: "
